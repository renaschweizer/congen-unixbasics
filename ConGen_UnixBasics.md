...
<details>	
	You can use the `du` command for the data_backup directory `du -hd1 ../data_backup/` 
...
<details>
	There are 1 million lines in each file. Given that there are 4 lines per 1 sequence read in a .fastq file, there are 250,000 reads in each file. 
</details>
